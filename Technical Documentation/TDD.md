...
### 2.4 Fuel Calculations

#### Taxi Fuel
- **Constant Value**: Taxi fuel is assumed to be a constant value of **3 litres**.
- **Weight Calculation**: Taxi fuel weight is calculated as `3 litres × 0.72 kg/L = 2.16 kg`.
- **Purpose**: This ensures consistency in fuel calculations and aligns with safety requirements.

#### Actual Flight Fuel
- **Calculation**: `actualFlightFuelLitres = actualDipLitres - TAXI_FUEL_LITRES`
- **Weight Calculation**: `actualFlightFuelWeight = actualFlightFuelLitres × 0.72 kg/L`
- **Purpose**: Reflects the fuel available for the flight after accounting for taxi fuel.
